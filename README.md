...
* 這邊使用的是 OpenVINO 來進行模型優化，有將模型以 FP32、FP16 進行參數量化，而原先模型就是 FP32，這邊使用 OpenVINO 並維持 FP32 仍然能有較高的 FPS 是因為 OpenVINO 本身就會做一些 Layer fusion，將某些能夠簡化的架構併在 CNN layer 當中，像是 Batch-Norm、Scale-Shift 都能夠將他轉換為矩陣後與 CNN Kernel 併在一起。
...
* 優化原理可以參考 OpenVINO 官網以及下方 Layer fusion 推導
